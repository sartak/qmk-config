    ...
    case 'a':
      switch (buffer[1]) {
        ...
        case 'n':
          switch (buffer[2]) {
            case 'd':
              ...
              break;
            case 'o':
              if (strcmp(buffer+3, /*ano*/"ther ") == 0) return "a+h+r";
              break;
            case 'y':
        ...
        case 's':
          ...
          break;
        case 't':
          if (strcmp(buffer+2, /*at*/" ") == 0) return "a+t+Dup";
          break;
      }
      break;
    case 'A':
        ...
        case 'o':
          switch (buffer[2]) {
            ...
            case 'n':
              switch (buffer[3]) {
                case 's':
                  if (strcmp(buffer+4, /*cons*/"ider ") == 0) return "c+n+d";
                  break;
                case 't':
                  if (strcmp(buffer+4, /*cont*/"inue ") == 0) return "c+n+t";
                  break;
              }
              break;
            case 'u':
    ...
    case 'f':
      switch (buffer[1]) {
        ...
        case 'e':
          switch (buffer[2]) {
            case 'e':
              if (strcmp(buffer+3, /*fee*/"l ") == 0) return "f+e+l";
              break;
            case 'w':
              if (strcmp(buffer+3, /*few*/" ") == 0) return "f+e+w";
              break;
          }
          break;
        case 'i':
        ...
        case 'e':
          switch (buffer[2]) {
            ...
            case 'a':
              ...
              break;
            case 'l':
              if (strcmp(buffer+3, /*hel*/"p ") == 0) return "h+l+p";
              break;
            case 'r':
            ...
            case 't':
              switch (buffer[3]) {
                case 'e':
                  ...
                  break;
                case 'o':
                  if (strcmp(buffer+4, /*into*/" ") == 0) return "i+u+Dup";
                  break;
              }
              break;
          }
        ...
        case 'o':
          switch (buffer[2]) {
            ...
            case 't':
              ...
              break;
            case 'w':
              if (strcmp(buffer+3, /*now*/" ") == 0) return "n+o+w";
              break;
          }
          break;
        case 'u':
          ...
          if (buffer[2] == 'a') {
              switch (buffer[3]) {
                ...
                case 'n':
                  ...
                  break;
                case 'y':
                  if (strcmp(buffer+4, /*play*/" ") == 0) return "p+l+y";
                  break;
              }
          }
          break;
    ...
    case 'w':
      switch (buffer[1]) {
        ...
        case 'e':
          switch (buffer[2]) {
            case ' ':
              if (buffer[3] == 0) /*we */ return "w+e+Dup";
              break;
            case 'l':
              if (strcmp(buffer+3, /*wel*/"l ") == 0) return "w+e+l";
              break;
          }
          break;
        case 'h':
          switch (buffer[2]) {
            ...
            case 'e':
              switch (buffer[3]) {
                case 'n':
                  if (strcmp(buffer+4, /*when*/" ") == 0) return "w+h+e";
                  break;
                case 'r':
                  if (strcmp(buffer+4, /*wher*/"e ") == 0) return "Dup+e+r";
                  break;
              }
              break;
            case 'i':
